...
object Build extends sbt.Build {  
  ...
  lazy val `pico-json` = Project(id = "pico-json", base = file("pico-json"))
      .standard("Tiny json library")
      .testLibs(specs2_core, specs2_scalacheck)

  lazy val all = Project(id = "pico-json-project", base = file("."))
      .notPublished
      .aggregate(`pico-json`, `pico-fake`)
}
